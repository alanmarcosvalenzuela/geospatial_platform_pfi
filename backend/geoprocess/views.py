...
class Process(APIView):
    ...
    def async_function(self, geoprocess, bbox, option, email):
        ...
        report_file_path = output_file  # Replace with the actual filename generated by sam.show_anns
        ...
        # email
        email= EmailMessage("Geoproceso ejecutado con éxito",
            "Esto es un test", 
            "terradata2023@gmail.com",
            [email]
        )
